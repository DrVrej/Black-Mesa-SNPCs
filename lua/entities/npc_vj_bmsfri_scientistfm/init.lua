...
-----------------------------------------------*/
ENT.Model = {"models/humans/scientist_female.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want 
ENT.StartHealth = GetConVarNumber("vj_bms_scientistfm_h")
...
function ENT:CustomOnInitialize()
	local randrace = math.random(1,7)
	if randrace == 1 then self:SetBodygroup(3,math.random(0,1)) self:SetSkin(0) end
	if randrace == 2 then self:SetBodygroup(3,2) self:SetSkin(1) end
	if randrace == 3 then self:SetBodygroup(3,math.random(3,4)) self:SetSkin(2) end
	if randrace == 4 then self:SetBodygroup(3,math.random(0,1)) self:SetSkin(3) end
	if randrace == 5 then self:SetBodygroup(3,math.random(3,4)) self:SetSkin(4) end
	if randrace == 6 then self:SetBodygroup(3,math.random(3,4)) self:SetSkin(5) end
	if randrace == 7 then self:SetBodygroup(3,math.random(3,4)) self:SetSkin(6) end
