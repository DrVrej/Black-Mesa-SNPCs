...
-----------------------------------------------*/
ENT.Model = {"models/zombies/zombie_sci.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = GetConVarNumber("vj_bms_zscientist_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_bms_zscientist_d")
