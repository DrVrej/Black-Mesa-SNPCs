...
-----------------------------------------------*/
ENT.Model = {"models/zombies/zombie_guard_torso.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = GetConVarNumber("vj_bms_zcop_torso_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_bms_zcop_torso_d")
