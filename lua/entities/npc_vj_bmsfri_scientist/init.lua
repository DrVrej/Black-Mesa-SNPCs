...
-----------------------------------------------*/
ENT.Model = {"models/humans/scientist.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want 
ENT.StartHealth = GetConVarNumber("vj_bms_scientist_h")
